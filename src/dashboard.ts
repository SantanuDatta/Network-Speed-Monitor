...
function stats(): string {
  return `<section><div class="page-title"><div><p class="eyebrow">SUMMARY</p><h1>Connection statistics</h1><p class="page-description">Historical measurements are stored locally on this device.</p></div></div><div class="stat-periods">${(
    [
